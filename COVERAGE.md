Compiling 132 files with Solc 0.8.24
Solc 0.8.24 finished in 5.89s
Compiler run successful with warnings:
Warning (2072): Unused local variable.
  --> src/PriceFeed.sol:26:10:
   |
26 |         (uint80 roundId, int256 price, uint256 startedAt, uint256 updatedAt, uint80 answeredInRound) =
   |          ^^^^^^^^^^^^^^

Warning (2072): Unused local variable.
  --> src/PriceFeed.sol:26:40:
   |
26 |         (uint80 roundId, int256 price, uint256 startedAt, uint256 updatedAt, uint80 answeredInRound) =
   |                                        ^^^^^^^^^^^^^^^^^

Warning (2072): Unused local variable.
  --> src/PriceFeed.sol:26:78:
   |
26 |         (uint80 roundId, int256 price, uint256 startedAt, uint256 updatedAt, uint80 answeredInRound) =
   |                                                                              ^^^^^^^^^^^^^^^^^^^^^^

Warning (2072): Unused local variable.
   --> test/GameFiExtra.t.sol:280:41:
    |
280 |         (bool fulfilled1, bool exists1, address u1, uint256 w1) = loot.s_requests(req1);
    |                                         ^^^^^^^^^^

Warning (2072): Unused local variable.
   --> test/GameFiExtra.t.sol:280:53:
    |
280 |         (bool fulfilled1, bool exists1, address u1, uint256 w1) = loot.s_requests(req1);
    |                                                     ^^^^^^^^^^

Warning (2072): Unused local variable.
   --> test/GameFiExtra.t.sol:281:41:
    |
281 |         (bool fulfilled2, bool exists2, address u2, uint256 w2) = loot.s_requests(req2);
    |                                         ^^^^^^^^^^

Warning (2072): Unused local variable.
   --> test/GameFiExtra.t.sol:281:53:
    |
281 |         (bool fulfilled2, bool exists2, address u2, uint256 w2) = loot.s_requests(req2);
    |                                                     ^^^^^^^^^^

Warning (2018): Function state mutability can be restricted to pure
   --> script/Deploy.s.sol:114:5:
    |
114 |     function _logAddresses(DeployedContracts memory dc) internal view {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> script/VerifyDeployment.s.sol:28:5:
   |
...
Warning (2018): Function state mutability can be restricted to pure
  --> test/Mocks.sol:41:5:
   |
41 |     function description() external view returns (string memory) {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to pure
  --> test/Mocks.sol:45:5:
   |
45 |     function version() external view returns (uint256) {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to pure
  --> test/Mocks.sol:75:5:
   |
75 |     function getRequestConfig() external view returns (uint16, uint32, bytes32[] memory) {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to pure
  --> test/Mocks.sol:79:5:
   |
79 |     function createSubscription() external returns (uint64) {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to pure
  --> test/Mocks.sol:83:5:
   |
83 |     function getSubscription(uint64) external view returns (uint96, uint64, uint64, address, address[] memory) {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to pure
  --> test/Mocks.sol:92:5:
   |
92 |     function pendingRequestExists(uint64) external view returns (bool) {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> test/Fork.t.sol:48:5:
   |
48 |     function testForkETHPrice() public {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> test/Fork.t.sol:54:5:
   |
54 |     function testForkWETHBalance() public {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> test/Fork.t.sol:60:5:
   |
60 |     function testForkChainlinkDecimals() public {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/Fuzz.t.sol:126:5:
    |
126 |     function testFuzzAMMGetAmountOut(uint256 amountIn) public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> test/GameFiExtra.t.sol:70:5:
   |
70 |     function testPriceFeed() public {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/GameFiExtra.t.sol:182:5:
    |
182 |     function testGovernorParams() public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/GameFiExtra.t.sol:240:5:
    |
240 |     function testProposalThreshold() public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/GameFiExtra.t.sol:244:5:
    |
244 |     function testTimelockAdmin() public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/GameFiExtra.t.sol:346:5:
    |
346 |     function testRentalVaultAssetMatches() public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/GameFiExtra.t.sol:350:5:
    |
350 |     function testLootVRFGameItemMatches() public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/GameFiExtra.t.sol:354:5:
    |
354 |     function testGovernorVotingDelay() public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/GameFiExtra.t.sol:358:5:
    |
358 |     function testGovernorVotingPeriod() public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/GameFiExtra.t.sol:362:5:
    |
362 |     function testTimelockMinDelayValue() public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/GameFiExtra.t.sol:366:5:
    |
366 |     function testTokenSymbol() public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> test/GameItem.t.sol:19:5:
   |
19 |     function testInitialization() public {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
   --> test/GameItem.t.sol:155:5:
    |
155 |     function testSupportsInterface() public {
    |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> test/Invariants.t.sol:47:5:
   |
47 |     function invariant_kProductNeverDecreases() public {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> test/Invariants.t.sol:56:5:
   |
56 |     function invariant_vaultBalanceCorrect() public {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> test/Invariants.t.sol:66:5:
   |
66 |     function invariant_lpSupplyCorrespondsToReserves() public {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> test/Invariants.t.sol:76:5:
   |
76 |     function invariant_reservesMatchBalance() public {
   |     ^ (Relevant source part starts here and spans across multiple lines).

Warning (2018): Function state mutability can be restricted to view
  --> test/Invariants.t.sol:81:5:
   |
81 |     function invariant_tokenTotalSupply() public {
   |     ^ (Relevant source part starts here and spans across multiple lines).
