...
contract GameAMMTest is Test {
    ...
    function setUp() public {
        ...
        tokenX.mint(user1, 1000000 * 10**18);
        tokenY.mint(user1, 1000000 * 10**18);
        
        tokenX.mint(user2, 1000000 * 10**18);
        tokenY.mint(user2, 1000000 * 10**18);
    ...
    function testFeeCalculation() public {
        ...
        uint256 numerator = 10000 * 10**18 * 997;
        uint256 denominator = 100997;
